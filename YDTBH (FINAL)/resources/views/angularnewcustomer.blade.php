  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 py-3 wow fadeInUp">
        ...
        <p>Let us Know what you think as you please.<br></p>
        ...
        -->
                            ...
                            $scope.addCustomer = () => {
                                $http.post('/ajaxcustomers', $scope.customer).then((result) => {
                                    if (result.data.result === 1) {
                                        window.location.href = '/thanksForRegistering';
                                    }
                                });
                            }
                        })
                    ...
                    <div class="container" ng-app="CustomerAddModule" ng-controller="CustomerAddController">
                        <form>
                            ...
                            <div class="form-group">
                                <label for="txtNit">Message</label>
                                <textarea id="txtNit" class="form-control" ng-model="customer.nit"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="txtAddress">Diagnosis</label>
